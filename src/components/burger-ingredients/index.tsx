...
const BurgerIngredients = () => {
  ...
  const bunsRef = React.createRef<HTMLHeadingElement>();
  const saucesRef = React.createRef<HTMLHeadingElement>()
  const mainRef = React.createRef<HTMLHeadingElement>()
  ...
  const switchTab = (val:string): void => {
    switch (val) {
      case bun:
