...
const OrderDetails = () => {
    ...
    return (
        <div className={styles.details}>
            ...
            {num === 0 ? <p className={`${styles.details__number} text text_type_main-medium pt-10`}>Подождите, идет формирование заказа</p> : <img src={done} className={`${styles.details__img} pt-15`} alt={num} />}
